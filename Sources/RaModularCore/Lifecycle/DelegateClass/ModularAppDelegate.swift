...
/// }
/// ```
open class ModularAppDelegate: BaseLifecycleDelegate<UIApplicationDelegate>, UIApplicationDelegate {
    open func application(
        _ application: UIApplication,
        willFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey : Any]? = nil
    ) -> Bool {
        return delegateServices.rmd.distribute {
    ...
    open func application(
        _ application: UIApplication,
        viewControllerWithRestorationIdentifierPath identifierservices: [String],
        coder: NSCoder
    ) -> UIViewController? {
        for services in delegateServices {
            if let controller = services.application?(
                application,
                viewControllerWithRestorationIdentifierPath: identifierservices,
                coder: coder
            ) {
                return controller
            }
    ...
    open func application(
        ...
        let returns = delegateServices.rmd.distribute {
